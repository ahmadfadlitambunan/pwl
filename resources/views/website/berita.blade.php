            ...
            <article class="post-item post-detail">
                ...
                <div class="post-item-body">
                    <div class="padding-10">
                        <h1>
                        @if($judul == 'SBMPTN')    
                            Seleksi Bersama Masuk Perguruan Tinggi Negeri Akan Dilaksanakan Bulan April {{$judul}}
                        @elseif($judul == 'SNMPTN')
                            Pengumuman SNMPTN Bisa Dicek Hari Ini
                        @else
                            {{$judul}} Belum Diketahui Pelaksanaanya
                        @endif
                        </h1>
